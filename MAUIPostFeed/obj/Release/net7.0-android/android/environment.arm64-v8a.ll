...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"12c39d0d-745f-40c9-8bda-f633282026a6\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [29 x i8] c"com.companyname.mauipostfeed\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555249, ; android_runtime_jnienv_class_token
	i32 100671968, ; jnienv_initialize_method_token
	i32 100671967, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.15 = internal constant [27 x i8] c"libaot-MAUIPostFeed.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [470 x %struct.DSOCacheEntry] [
	...
	; 14
	%struct.DSOCacheEntry {
		i64 536313522463184033, ; hash 0x7715e4ea2a814a1, from name: libaot-MAUIPostFeed.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 15
	%struct.DSOCacheEntry {
	...
	; 32
	%struct.DSOCacheEntry {
		i64 1326011624329420761, ; hash 0x1266f08bfc319fd9, from name: MAUIPostFeed.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 98
	%struct.DSOCacheEntry {
		i64 3957462097929837719, ; hash 0x36ebbacf7f2e1c97, from name: libaot-MAUIPostFeed
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 172
	%struct.DSOCacheEntry {
		i64 7633909787483537960, ; hash 0x69f118816a558228, from name: aot-MAUIPostFeed.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 302
	%struct.DSOCacheEntry {
		i64 12089808666393308078, ; hash 0xa7c7a0ed72cfebae, from name: MAUIPostFeed
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 405
	%struct.DSOCacheEntry {
		i64 15901105042583016224, ; hash 0xdcac12c9df555320, from name: aot-MAUIPostFeed
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
